  ...
  return (
    <section id="selected-works" className="py-20 sm:py-24">
      <div className="mx-auto max-w-[90rem] px-6 sm:px-10 lg:px-14">
        ...
        {errorMessage ? (
          <p className="mt-12 max-w-2xl text-sm leading-7 text-white/60">
            Selected works are temporarily unavailable. Please check back
            shortly.
          </p>
        ) : works.length === 0 ? (
          <p className="mt-12 max-w-2xl text-sm leading-7 text-white/60">
            Selected works are being curated. New entries are on their way.
          </p>
        ) : (
